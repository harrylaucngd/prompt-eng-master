            ...
            for key in data.keys():
                ...
                for i in range(len(data[topic])):
                    ...
                    for label_name in labels.keys():
                        ...
                        ans[topic][i]["label"][label_name] = self.few_shot_cot_critique(topic, input_name, input_value, label_name, example, model_name, temp, GPT=True)
